...
# Run Ubound
/usr/sbin/unbound -p -v -d -c /etc/unbound/unbound.conf &
/usr/sbin/unbound-anchor -4 -r /var/lib/unbound/root.hints -a /var/lib/unbound/root.key

#Run Cloudflare DNS
/usr/local/bin/cloudflared proxy-dns --port 5153 --upstream https://1.1.1.1/dns-query --upstream https://1.0.0.1/dns-query --upstream https://2606:4700:4700::1111/dns-query --upstream https://2606:4700:4700::1001/dns-query &
